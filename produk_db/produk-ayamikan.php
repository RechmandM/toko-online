<section id="sayuran" class="text-center">
    <div class="container">
        <div class="pt-5">
            <div class="">
                <h3 class="fw-bold text-info">Ayam, Ikan & Udang</h3>
                <hr>
                <div class="card py-2 mb-3">
                    <?php
                    $row = mysqli_query($conn, "SELECT * From tanggal where kategori='ayamikan'");
...
<section id="Produk" class="text-center">
    <div class="container">
        <div>
            <div class="row">
                <?php
                // $row = mysqli_query($conn, "SELECT * From ayamikan order by stok DESC, nama ASC");
                $row = mysqli_query($conn, "SELECT * From ayamikan where stok between '1' and '2' order by stok DESC, nama ASC");
                $img = 1;
                foreach ($row as $row_array) {
                ?>
                    <div class="col-6 col-md-3 mb-3" data-aos="fade">
                        <div class="card">
                            <img src="./img/produk/ayamikan/<?= $row_array['id'] . '.jpg'; ?>" class="card-img-top" alt="..." width="auto">
                ...
                $row = mysqli_query($conn, "SELECT * From ayamikan where stok='0' order by nama ASC");
                $img = 1;
                foreach ($row as $row_array) {
                ?>
                    <div class="col-6 col-md-3 mb-3" data-aos="fade">
