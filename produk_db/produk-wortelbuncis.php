...
<section id="Produk" class="text-center">
    <div class="container">
        <div>
            <div class="row">
                <?php
                $row = mysqli_query($conn, "SELECT * From wortelbuncis where stok between '1' and '2' order by tipe, stok DESC");
                $img = 1;
                ...
                $row = mysqli_query($conn, "SELECT * From wortelbuncis where stok='0' order by tipe");
                $img = 1;
                foreach ($row as $row_array) {
                ?>
                    <div class="col-6 col-md-3 mb-3" data-aos="fade">
