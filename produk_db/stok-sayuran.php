    ...
    <div class="container" data-aos="fade">
        <div>
            <form method="POST" class="needs-validation" novalidate style="font-size: larger;">
                <div class="row">
                    <?php
                    $row = mysqli_query($conn, "SELECT * From sayuran order by stok DESC, tipe");
                    $img = 1;
...
if (isset($_POST['submit'])) {
    ...
    foreach ($row as $row_array) {
        ...
        // $ambil = $_POST["ambil$row_array[id]"];
        mysqli_query($conn, "UPDATE sayuran set stok='$ambil' where id='$idku'");
    }
    $kategori = "sayuran";
    ...
    echo "<script>window.location = 'admin.php?mi=sayuran'</script>";
